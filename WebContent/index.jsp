      ...
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
            ...
            <li><a href="#"><i class="fa fa-bar-chart fa-fw"></i>学期选课</a></li>
            <li><a href="#"><i class="fa fa-database fa-fw"></i>其他选课</a></li>
            <li><a href="#"><i class="fa fa-map-marker fa-fw"></i>修读课程</a></li>
